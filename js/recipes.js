...
export const RECIPES = [
  ...
  // ── 韓式泡菜豆腐鍋 ────────────────────────────────────────
  {
    id: 5,
    title: '韓式泡菜豆腐鍋',
    subtitle: 'Kimchi Jjigae with Tofu',
    description: '濃郁酸辣的韓式湯頭，吸滿湯汁的軟嫩豆腐與鮮甜豬五花，最後打上一顆雞蛋，熱呼呼的下飯神器。',
    category: '晚餐',
    cuisine: '韓式',
    meal_type: '湯',
    tags: ['燉煮', '辣', '湯'],
    ...
    time_estimate: '15 分鐘',
    difficulty: '簡單',
    image: 'images/kimchi_tofu_stew.png',
    ...
    ingredients: [
      ...
      {
        ingredient_id: 'chicken_broth',
        variant_id:    'chicken_broth--canned',
        qty: 200, unit: 'ml',
        scalable: true, optional: false, is_seasoning: false,
      },
      {
      ...
      {
        ingredient_id: 'vegetable_oil',
        variant_id:    'vegetable_oil--regular',
        qty: null, unit: '適量',
      ...
      {
        ingredient_id: 'dried_chili',
        variant_id:    'dried_chili--korean_powder',
        qty: null, unit: '適量',
        scalable: false, optional: false, is_seasoning: true,
      },
    ],
    ...
    versions: [
      {
        ...
        steps: [
          {
            order: 1,
            instruction: '洋蔥和蒜切末，豆腐切塊備用。',
            ingredient_ids: ['onion--yellow', 'garlic_raw--minced', 'tofu--firm'],
          },
          {
            order: 2,
            instruction: '熱鍋下適量油，爆香洋蔥末和蒜末。',
            method_id: 'stir_fry_medium_heat',
            duration_s: 60,
            ingredient_ids: ['vegetable_oil--regular', 'onion--yellow', 'garlic_raw--minced'],
          },
          {
            order: 3,
            instruction: '放入泡菜炒香，讓酸氣釋放。',
            method_id: 'stir_fry_medium_heat',
            duration_s: 60,
            ingredient_ids: ['kimchi--fermented'],
          },
          {
            order: 4,
            instruction: '加入高湯和水，煮滾。',
            method_id: 'simmer_medium_heat',
            duration_s: 180,
            ingredient_ids: ['chicken_broth--canned', 'water--cold'],
          },
          {
            order: 5,
            instruction: '加入豬肉片煮熟。',
            method_id: 'simmer_medium_heat',
            duration_s: 120,
            ingredient_ids: ['pork_belly--sliced'],
          },
          {
            order: 6,
            instruction: '放入豆腐燉煮入味（約3-5分鐘），起鍋前用糖、鹽及韓式辣椒粉調味，淋上香油，並打一顆蛋煮到喜歡的熟度即完成。',
            method_id: 'simmer_low_heat',
            duration_s: 300,
            ingredient_ids: ['tofu--firm', 'sugar--white', 'salt--sea', 'dried_chili--korean_powder', 'sesame_oil--roasted', 'egg_chicken--raw'],
          },
        ],
      },
    ],

    tips: '想要更濃郁也可以加入一小匙韓式辣醬。高湯可以用清水或者洗米水替代。',
  },
  ...
  // ── 法式白酒燉雞 ────────────────────────────────────────
  {
    id: 6,
    title: '法式白酒燉雞',
    subtitle: 'Fricassée de Poulet',
    description: '經典的法國家常菜，將雞肉的焦香與洋蔥一同在白酒及鮮奶油中燉煮，湯汁濃郁滑順，搭配麵包超級美味！',
    category: '晚餐',
    cuisine: '法式',
    meal_type: '料理',
    tags: ['燉煮', '濃郁', '經典'],
    ...
    time_estimate: '30 分鐘',
    difficulty: '中等',
    image: 'images/french_chicken_stew.png',

    ingredients: [
      {
        ingredient_id: 'chicken_thigh',
        variant_id:    'chicken_thigh--boneless',
        qty: 150, unit: 'g',
        scalable: true, optional: false, is_seasoning: false,
        note: '切塊',
      },
      ...
      {
        ingredient_id: 'garlic_raw',
        variant_id:    'garlic_raw--sliced',
        qty: 1, unit: '瓣',
        scalable: true, optional: false, is_seasoning: false,
      },
      {
        ingredient_id: 'wine_white',
        variant_id:    'wine_white--cooking',
        qty: 30, unit: 'ml',
        scalable: true, optional: false, is_seasoning: true,
      },
      {
    ...
    versions: [
      {
        id: 'stovetop',
        label: '爐灶版',
        note: '慢火燉煮，使雞肉吸滿奶油白酒香氣。',
        steps: [
          {
            order: 1,
            instruction: '雞肉洗淨擦乾，用少許鹽和黑胡椒醃製 15 分鐘。',
            method_id: 'marinate',
            duration_s: 900,
            ingredient_ids: ['chicken_thigh--boneless', 'salt--sea', 'black_pepper--ground'],
          },
          {
            order: 2,
            instruction: '鍋中放入奶油，將雞肉表面煎至金黃上色（不用全熟），取出備用。',
            method_id: 'pan_fry_medium_heat',
            duration_s: 180,
            ingredient_ids: ['butter--unsalted', 'chicken_thigh--boneless'],
          },
          {
            order: 3,
            instruction: '利用鍋中餘油，放入洋蔥丁炒至透明，再加入蒜片爆香。',
            method_id: 'stir_fry_medium_heat',
            duration_s: 180,
            ingredient_ids: ['onion--yellow', 'garlic_raw--sliced'],
          },
          {
            order: 4,
            instruction: '倒入白酒，煮至酒味稍揮發，接著加入雞高湯與百里香，將雞肉放回鍋中。',
            method_id: 'simmer_medium_heat',
            duration_s: 120,
            ingredient_ids: ['wine_white--cooking', 'chicken_broth--canned', 'thyme--dried'],
          },
          {
            order: 5,
            instruction: '蓋上鍋蓋轉中小火燉煮 15 分鐘煮熟雞肉。',
            method_id: 'simmer_low_heat',
            duration_s: 900,
            ingredient_ids: [],
          },
          {
            order: 6,
            instruction: '打開鍋蓋，倒入鮮奶油，轉中火繼續煮至醬汁濃稠，最後依口味加鹽及黑胡椒調整即可。',
            method_id: 'simmer_medium_heat',
            duration_s: 120,
            ingredient_ids: ['heavy_cream--liquid', 'salt--sea', 'black_pepper--ground'],
          },
        ],
      },
    ],

    tips: '煎雞肉時產生的鍋底焦香是這道菜風味濃郁的來源，務必保留哦！鮮奶油加入後不宜久煮，以免油水分離。',
  },
  ...
  // ── 鹹蛋雞肉豆腐煲 ────────────────────────────────────────
  {
    id: 7,
    title: '鹹蛋雞肉豆腐煲',
    subtitle: 'Salted Egg Chicken Tofu',
    description: '超級下飯的家常料理！鹹蛋的濃郁鹹香配上滑嫩的豆腐與鮮嫩的雞肉，金黃色澤讓人食指大動。',
    category: '晚餐',
    cuisine: '台式',
    meal_type: '料理',
    tags: ['燉煮', '下飯', '香濃'],
    ...
    time_estimate: '25 分鐘',
    difficulty: '中等',
    image: 'images/salted_egg_chicken_tofu.png',
    ...
    ingredients: [
      ...
      {
        ingredient_id: 'egg_duck',
        variant_id:    'egg_duck--salted',
        qty: 1, unit: '顆',
        scalable: true, optional: false, is_seasoning: false,
        note: '蛋黃與蛋白分開並切碎',
      },
      ...
      {
        ingredient_id: 'white_pepper_powder',
        variant_id:    'white_pepper_powder--ground',
        qty: null, unit: '少許',
        scalable: false, optional: true, is_seasoning: true,
      },
    ],
    ...
    versions: [
      {
        id: 'stovetop',
        label: '爐灶版',
        note: '砂鍋保溫效果好，更能保持煲湯的溫度與風味。',
        steps: [
          {
            order: 1,
            instruction: '雞腿肉切丁，加入米酒、醬油與少許太白粉抓勻，醃漬約 10 分鐘。',
            method_id: 'marinate',
            duration_s: 600,
            ingredient_ids: ['chicken_thigh--boneless', 'sake_cooking--rice', 'soy_sauce--regular', 'cornstarch--potato'],
          },
          {
            order: 2,
            instruction: '雞蛋豆腐切塊，鍋中熱少許油，將豆腐煎至表面微黃，盛起備用。',
            method_id: 'pan_fry_medium_heat',
            duration_s: 300,
            ingredient_ids: ['tofu--egg', 'vegetable_oil--regular'],
          },
          {
            order: 3,
            instruction: '原鍋用中小火先將鹹蛋黃碎炒至起泡、散發出香氣，再加入蛋白碎繼續拌炒。',
            method_id: 'stir_fry_medium_heat',
            duration_s: 120,
            ingredient_ids: ['egg_duck--salted'],
          },
          {
            order: 4,
            instruction: '加入蒜末炒香，接著放入醃好的雞肉丁炒至變色。',
            method_id: 'stir_fry_high_heat',
            duration_s: 180,
            ingredient_ids: ['garlic_raw--minced', 'chicken_thigh--boneless'],
          },
          {
            order: 5,
            instruction: '倒入清水煮滾，並放回煎好的豆腐。轉小火蓋上鍋蓋燜煮 5 分鐘。',
            method_id: 'simmer_low_heat',
            duration_s: 300,
            ingredient_ids: ['water--cold', 'tofu--egg'],
          },
          {
            order: 6,
            instruction: '若需要可加鹽、白胡椒調味。起鍋前以少許太白粉水勾薄芡，撒上蔥花即完成。',
            method_id: 'thicken_sauce',
            duration_s: 60,
            ingredient_ids: ['salt--sea', 'white_pepper_powder--ground', 'cornstarch--potato', 'green_onion--chopped'],
          },
        ],
      },
    ],

    tips: '豆腐先煎過可以避免在燉煮時碎裂，並賦予外焦裡嫩的口感。鹹鴨蛋本身的鹹度差異很大，請試味道後再決定要加多少鹽巴喔！',
  },
];
