...
export default function KitchenPage({ recipes }: KitchenPageProps) {
  ...
  return (
    <div className="page-view active" id="view-kitchen">
      <div className="kitchen-page-header">
        <h1 className="kitchen-page-title">廚房</h1>
        <p className="kitchen-page-subtitle">選擇手邊有的食材，快速找出能做的料理。</p>
      </div>
